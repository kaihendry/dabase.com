...
Octopus Energy integration for grid consumption — it pulls accurate meter readings directly
from Octopus via their API.

- **Octopus Energy** (meter 16MXXXXXX) — grid source
  - Main house (shellyem-C4D8D5002A0D Channel 1)
  - Cottage (Tuya PJ2101A 1P WiFi Smart Meter)
  - Garage *(not monitored)*
