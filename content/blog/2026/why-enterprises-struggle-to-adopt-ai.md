...
Anthropic's announced [Enterprise Frontier Safeguards](https://www.anthropic.com/news/enterprise-frontier-safeguards) combines ZDR privacy with misuse detection by keeping monitoring data in customer-controlled cloud infrastructure. It's due to roll out in phases later this autumn, across enterprise products as well as the API. Both [Anthropic](https://platform.claude.com/docs/en/manage-claude/api-and-data-retention) and [OpenAI](https://developers.openai.com/api/docs/guides/your-data#zero-data-retention) offer ZDR, but their model coverage, feature exclusions, and safety-retention exceptions differ.

Under [GDPR's storage-limitation principle](https://commission.europa.eu/law/law-topic/data-protection/information-business-and-organisations/principles-gdpr_en), personal data must be kept no longer than necessary; zero retention is not a universal requirement. ZDR can reduce exposure, but sending personal data to a model is still processing: lawful basis, [processor terms](https://www.edpb.europa.eu/sme/learn-the-basics/data-controller-or-data-processor_en), and [international-transfer safeguards](https://www.edpb.europa.eu/topics/international-transfers-and-international-cooperation_en) where applicable still matter. With EFS, customer-held monitoring logs also need a justified purpose, limited access, and a retention period. Neither a ZDR label nor customer-controlled storage establishes GDPR compliance on its own.
