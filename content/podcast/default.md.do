...
# Build the ## Summary section: replace [slide:N] with inline images and [MM:SS] with deeplinks
SUMMARY_SECTION=""
if [ -n "$SUMMARY_JSON" ]; then
    SUMMARY_SECTION=$(echo "$SUMMARY_JSON" | python3 -c "
...
print('## Summary\n\n{}\n\n*Generated by {}*'.format(linked, model))
")
fi
